...
global.ownername = process.env.OWNER_NAME === undefined ? "Toumatito" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '541141421436' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
global.ownernumber = [`${fake}`]
global.premium = [`${fake}`]
global.anticall = process.env.ANTICALL === undefined ? 'false' : process.env.ANTICALL
global.packname = process.env.PACK_NAME === undefined ? 'BGT' : process.env.PACK_NAME
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? 'Toumatito' : process.env.STICKER_AUTHOR_NAME
